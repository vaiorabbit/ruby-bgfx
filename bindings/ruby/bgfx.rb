...
module Bgfx
	...
	#
	def self.topology_convert(_conversion, _dst, _dstSize, _indices, _numIndices, _index32); return bgfx_topology_convert(_conversion, _dst, _dstSize, _indices, _numIndices, _index32); end
	...
	# _index32 = Set to `true` if input indices are 32-bit.
	#
	def self.topology_sort_tri_list(_sort, _dst, _dstSize, _dir, _pos, _vertices, _stride, _indices, _numIndices, _index32); return bgfx_topology_sort_tri_list(_sort, _dst, _dstSize, _dir, _pos, _vertices, _stride, _indices, _numIndices, _index32); end
	...
	#
	def self.get_renderer_name(_type); return bgfx_get_renderer_name(_type); end
	
	def self.init_ctor(_init); return bgfx_init_ctor(_init); end
	...
	#
	def self.init(_init); return bgfx_init(_init); end
	
	#
	# Shutdown bgfx library.
	#
	def self.shutdown(); return bgfx_shutdown(); end
	...
	#
	def self.get_renderer_type(); return bgfx_get_renderer_type(); end
	...
	#   Library must be initialized.
	#
	def self.get_caps(); return bgfx_get_caps(); end
	
	#
	# Returns performance counters.
	# Attention: Pointer returned is valid until `bgfx::frame` is called.
	#
	def self.get_stats(); return bgfx_get_stats(); end
	...
	#
	def self.alloc(_size); return bgfx_alloc(_size); end
	...
	#
	def self.copy(_data, _size); return bgfx_copy(_data, _size); end
	...
	# _size = Size of data.
	#
	def self.make_ref(_data, _size); return bgfx_make_ref(_data, _size); end
	...
	#
	def self.set_debug(_debug); return bgfx_set_debug(_debug); end
	...
	#
	def self.dbg_text_printf(_x, _y, _attr, _format, *vargargs); return bgfx_dbg_text_printf(_x, _y, _attr, _format, *vargargs); end
	...
	#
	def self.dbg_text_vprintf(_x, _y, _attr, _format, _argList); return bgfx_dbg_text_vprintf(_x, _y, _attr, _format, _argList); end
	...
	#
	def self.dbg_text_image(_x, _y, _width, _height, _data, _pitch); return bgfx_dbg_text_image(_x, _y, _width, _height, _data, _pitch); end
	...
	# _handle = Static index buffer handle.
	#
	def self.destroy_index_buffer(_handle); return bgfx_destroy_index_buffer(_handle); end
	...
	#
	def self.create_vertex_layout(_layout); return bgfx_create_vertex_layout(_layout); end
	...
	#
	def self.destroy_vertex_layout(_layoutHandle); return bgfx_destroy_vertex_layout(_layoutHandle); end
	...
	# _handle = Static vertex buffer handle.
	#
	def self.destroy_vertex_buffer(_handle); return bgfx_destroy_vertex_buffer(_handle); end
	...
	# _mem = Index buffer data.
	#
	def self.update_dynamic_index_buffer(_handle, _startIndex, _mem); return bgfx_update_dynamic_index_buffer(_handle, _startIndex, _mem); end
	...
	# _handle = Dynamic index buffer handle.
	#
	def self.destroy_dynamic_index_buffer(_handle); return bgfx_destroy_dynamic_index_buffer(_handle); end
	...
	# _mem = Vertex buffer data.
	#
	def self.update_dynamic_vertex_buffer(_handle, _startVertex, _mem); return bgfx_update_dynamic_vertex_buffer(_handle, _startVertex, _mem); end
	...
	# _handle = Dynamic vertex buffer handle.
	#
	def self.destroy_dynamic_vertex_buffer(_handle); return bgfx_destroy_dynamic_vertex_buffer(_handle); end
	...
	#
	def self.get_avail_transient_index_buffer(_num); return bgfx_get_avail_transient_index_buffer(_num); end
	...
	# _layout = Vertex layout.
	#
	def self.get_avail_transient_vertex_buffer(_num, _layout); return bgfx_get_avail_transient_vertex_buffer(_num, _layout); end
	...
	#
	def self.get_avail_instance_data_buffer(_num, _stride); return bgfx_get_avail_instance_data_buffer(_num, _stride); end
	...
	#
	def self.alloc_transient_index_buffer(_tib, _num); return bgfx_alloc_transient_index_buffer(_tib, _num); end
	...
	# _layout = Vertex layout.
	#
	def self.alloc_transient_vertex_buffer(_tvb, _num, _layout); return bgfx_alloc_transient_vertex_buffer(_tvb, _num, _layout); end
	...
	#
	def self.alloc_transient_buffers(_tvb, _layout, _numVertices, _tib, _numIndices); return bgfx_alloc_transient_buffers(_tvb, _layout, _numVertices, _tib, _numIndices); end
	...
	#
	def self.alloc_instance_data_buffer(_idb, _num, _stride); return bgfx_alloc_instance_data_buffer(_idb, _num, _stride); end
	...
	#
	def self.create_indirect_buffer(_num); return bgfx_create_indirect_buffer(_num); end
	...
	#
	def self.destroy_indirect_buffer(_handle); return bgfx_destroy_indirect_buffer(_handle); end
	...
	# _mem = Shader binary.
	#
	def self.create_shader(_mem); return bgfx_create_shader(_mem); end
	...
	# _handle = Shader handle.
	#
	def self.destroy_shader(_handle); return bgfx_destroy_shader(_handle); end
	...
	#
	def self.destroy_program(_handle); return bgfx_destroy_program(_handle); end
	...
	#
	def self.is_texture_valid(_depth, _cubeMap, _numLayers, _format, _flags); return bgfx_is_texture_valid(_depth, _cubeMap, _numLayers, _format, _flags); end
	...
	# _format = Texture format. See: `TextureFormat::Enum`.
	#
	def self.calc_texture_size(_info, _width, _height, _depth, _cubeMap, _hasMips, _numLayers, _format); return bgfx_calc_texture_size(_info, _width, _height, _depth, _cubeMap, _hasMips, _numLayers, _format); end
	...
	# _mem = Texture update data.
	#
	def self.update_texture_3d(_handle, _mip, _x, _y, _z, _width, _height, _depth, _mem); return bgfx_update_texture_3d(_handle, _mip, _x, _y, _z, _width, _height, _depth, _mem); end
	...
	# _handle = Texture handle.
	#
	def self.get_direct_access_ptr(_handle); return bgfx_get_direct_access_ptr(_handle); end
	...
	# _handle = Texture handle.
	#
	def self.destroy_texture(_handle); return bgfx_destroy_texture(_handle); end
	...
	# _handle = Frame buffer handle.
	#
	def self.destroy_frame_buffer(_handle); return bgfx_destroy_frame_buffer(_handle); end
	...
	# _info = Uniform info.
	#
	def self.get_uniform_info(_handle, _info); return bgfx_get_uniform_info(_handle, _info); end
	...
	# _handle = Handle to uniform object.
	#
	def self.destroy_uniform(_handle); return bgfx_destroy_uniform(_handle); end
	
	#
	# Create occlusion query.
	#
	def self.create_occlusion_query(); return bgfx_create_occlusion_query(); end
	...
	# _handle = Handle to occlusion query object.
	#
	def self.destroy_occlusion_query(_handle); return bgfx_destroy_occlusion_query(_handle); end
	...
	#
	def self.set_palette_color(_index, _rgba); return bgfx_set_palette_color(_index, _rgba); end
	...
	#
	def self.set_palette_color_rgba8(_index, _rgba); return bgfx_set_palette_color_rgba8(_index, _rgba); end
	...
	# _name = View name.
	#
	def self.set_view_name(_id, _name); return bgfx_set_view_name(_id, _name); end
	...
	#
	def self.set_view_rect(_id, _x, _y, _width, _height); return bgfx_set_view_rect(_id, _x, _y, _width, _height); end
	...
	#
	def self.set_view_rect_ratio(_id, _x, _y, _ratio); return bgfx_set_view_rect_ratio(_id, _x, _y, _ratio); end
	...
	# default back buffer.
	#
	def self.set_view_frame_buffer(_id, _handle); return bgfx_set_view_frame_buffer(_id, _handle); end
	...
	#
	def self.set_view_transform(_id, _view, _proj); return bgfx_set_view_transform(_id, _view, _proj); end
	...
	#
	def self.reset_view(_id); return bgfx_reset_view(_id); end
	...
	#
	def self.encoder_begin(_forThread); return bgfx_encoder_begin(_forThread); end
	...
	# _encoder = Encoder.
	#
	def self.encoder_end(_encoder); return bgfx_encoder_end(_encoder); end
	...
	#
	def self.request_screen_shot(_handle, _filePath); return bgfx_request_screen_shot(_handle, _filePath); end
	...
	# _data = Platform data.
	#
	def self.set_platform_data(_data); return bgfx_set_platform_data(_data); end
	...
	#
	def self.get_internal_data(); return bgfx_get_internal_data(); end
	...
	#
	def self.override_internal_texture_ptr(_handle, _ptr); return bgfx_override_internal_texture_ptr(_handle, _ptr); end
	...
	#   sampling.
	#
	def self.override_internal_texture(_handle, _width, _height, _numMips, _format, _flags); return bgfx_override_internal_texture(_handle, _width, _height, _numMips, _format, _flags); end
	...
	#
	def self.set_marker(_marker); return bgfx_set_marker(_marker); end
	...
	#
	def self.set_condition(_handle, _visible); return bgfx_set_condition(_handle, _visible); end
	...
	# _height = Height of view scissor region.
	#
	def self.set_scissor(_x, _y, _width, _height); return bgfx_set_scissor(_x, _y, _width, _height); end
	...
	#
	def self.set_transform(_mtx, _num); return bgfx_set_transform(_mtx, _num); end
	...
	#
	def self.alloc_transform(_transform, _num); return bgfx_alloc_transform(_transform, _num); end
	...
	#
	def self.set_index_buffer(_handle, _firstIndex, _numIndices); return bgfx_set_index_buffer(_handle, _firstIndex, _numIndices); end
	...
	# _numIndices = Number of indices to render.
	#
	def self.set_dynamic_index_buffer(_handle, _firstIndex, _numIndices); return bgfx_set_dynamic_index_buffer(_handle, _firstIndex, _numIndices); end
	...
	# _numIndices = Number of indices to render.
	#
	def self.set_transient_index_buffer(_tib, _firstIndex, _numIndices); return bgfx_set_transient_index_buffer(_tib, _firstIndex, _numIndices); end
	...
	#
	def self.set_vertex_buffer(_stream, _handle, _startVertex, _numVertices); return bgfx_set_vertex_buffer(_stream, _handle, _startVertex, _numVertices); end
	...
	# _numVertices = Number of vertices to render.
	#
	def self.set_dynamic_vertex_buffer(_stream, _handle, _startVertex, _numVertices); return bgfx_set_dynamic_vertex_buffer(_stream, _handle, _startVertex, _numVertices); end
	...
	# _numVertices = Number of vertices to render.
	#
	def self.set_transient_vertex_buffer(_stream, _tvb, _startVertex, _numVertices); return bgfx_set_transient_vertex_buffer(_stream, _tvb, _startVertex, _numVertices); end
	...
	#
	def self.set_vertex_count(_numVertices); return bgfx_set_vertex_count(_numVertices); end
	...
	#
	def self.set_instance_data_buffer(_idb, _start, _num); return bgfx_set_instance_data_buffer(_idb, _start, _num); end
	...
	# Set instance data buffer for draw primitive.
	#
	def self.set_instance_data_from_vertex_buffer(_handle, _startVertex, _num); return bgfx_set_instance_data_from_vertex_buffer(_handle, _startVertex, _num); end
	...
	# _num = Number of data instances.
	#
	def self.set_instance_data_from_dynamic_vertex_buffer(_handle, _startVertex, _num); return bgfx_set_instance_data_from_dynamic_vertex_buffer(_handle, _startVertex, _num); end
	...
	# Attention: Availability depends on: `BGFX_CAPS_VERTEX_ID`.
	#
	def self.set_instance_count(_numInstances); return bgfx_set_instance_count(_numInstances); end
	...
	# _id = View id.
	#
	def self.touch(_id); return bgfx_touch(_id); end
	...
	#
	def self.set_compute_index_buffer(_stage, _handle, _access); return bgfx_set_compute_index_buffer(_stage, _handle, _access); end
	...
	# _access = Buffer access. See `Access::Enum`.
	#
	def self.set_compute_vertex_buffer(_stage, _handle, _access); return bgfx_set_compute_vertex_buffer(_stage, _handle, _access); end
	...
	# _access = Buffer access. See `Access::Enum`.
	#
	def self.set_compute_dynamic_index_buffer(_stage, _handle, _access); return bgfx_set_compute_dynamic_index_buffer(_stage, _handle, _access); end
	...
	# _access = Buffer access. See `Access::Enum`.
	#
	def self.set_compute_dynamic_vertex_buffer(_stage, _handle, _access); return bgfx_set_compute_dynamic_vertex_buffer(_stage, _handle, _access); end
	...
	# _access = Buffer access. See `Access::Enum`.
	#
	def self.set_compute_indirect_buffer(_stage, _handle, _access); return bgfx_set_compute_indirect_buffer(_stage, _handle, _access); end
